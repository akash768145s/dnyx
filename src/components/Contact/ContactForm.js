...
export default function ContactForm() {
  ...
  const onSubmit = (data) => {
    const mailtoLink = `mailto:sakthimuruganakash@gmail.com?subject=${encodeURIComponent(
      ...
      `Hello! My name is ${data.name} and I want to discuss a potential project. You can email me at ${data.email} or reach out to me on ${data["phone number"]}. Here are some details about my project: ${data["project details"]}`
    )}`;
